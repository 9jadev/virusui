...
export default {
    ...
    methods: {
        ...
        getransactions() {
            ...
            this.$axios.post(`${process.env.baseUrl}admin/lists/transfer`,
                {
                ...
                console.log(res.data.transfers.data)
                this.user = res.data.user
                this.transactions = res.data.transfers.data
                if (res.data.status == 'error') {
                    window.location.assign('/dashboard')
                }
                this.first_page_url = res.data.transfers.first_page_url
                this.last_page_url = res.data.transfers.last_page_url
                this.next_page_url = res.data.transfers.next_page_url
                this.prev_page_url = res.data.transfers.prev_page_url
                this.to = res.data.transfers.to
                this.total = res.data.transfers.total
                this.from = res.data.transfers.from
