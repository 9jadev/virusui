                        ...
                        <Table>
                            ...
                            <tbody v-if="transactions.length != 0 && transactions != null">
                                <tr v-for="(transaction, index) in transactions" :key="index">
                                    ...
                                    <td>{{ transaction.refs }}</td>
                                    <td> 
                                        <b-badge v-if="transaction.fund != null" variant="success">Funding</b-badge>
                                        <b-badge v-if="transaction.payment != null" variant="primary">Payments</b-badge>
                                        <b-badge v-if="transaction.transfer != null" variant="success">Transfer</b-badge>
                                        <b-badge v-if="transaction.recuring != null" variant="success">Recuring</b-badge>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <b-button :to="`/dashboard/payments/show/${transaction.payment.id}`" v-if="transaction.payment != null" size="sm" variant="primary">More</b-button>

                                        <b-button :to="`/dashboard/funds/${transaction.fund.id}`" v-if="transaction.fund != null" size="sm" variant="primary">More</b-button>

                                        <b-button :to="`/dashboard/transfers/${transaction.transfer.id}`" v-if="transaction.transfer != null" size="sm" variant="primary">More</b-button>
...
export default {
    ...
    methods: {
        ...
        getransactions() {
            ...
            this.$axios.post(`${process.env.baseUrl}transactions/admin/latest`,
                {
                ...
                this.transactions = res.data.transaction.data
                this.first_page_url = res.data.transaction.first_page_url
                this.last_page_url = res.data.transaction.last_page_url
                this.next_page_url = res.data.transaction.next_page_url
                this.prev_page_url = res.data.transaction.prev_page_url
                this.to = res.data.transaction.to
                this.total = res.data.transaction.total
