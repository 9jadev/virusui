                ...
                <div class="card shadow-lg mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="float-left">
                            <h2 class="card-title">{{ payment_type }} Payments</h2>
                        ...
                        <Table>
                            ...
                            <tbody v-if="transactions.length != 0">
                                <tr v-for="(transaction, index) in transactions" :key="index">
                                    ...
                                    <td>
                                        <!-- <b-button  v-if="payment_type == 'transfer'" :to="`/dashboard/transfers/${transaction.id}`" size="sm" variant="primary">More</b-button> -->

                                        <b-button :to="`/dashboard/payments/show/${transaction.id}`" size="sm" variant="primary">More</b-button>
                                    </td>
                                </tr>
                            </tbody>
                            <tbody v-else>
                                <tr>
                                    <td colspan="8" class="text-center"> <h3> No record... </h3> </td>
                                </tr>
                            </tbody>
                        </Table>
                        <div class=" col-md-12">
...
export default {
    ...
    async asyncData({ params, $axios, redirect }) {
        let services = ["airtime", "buydata", "electricity", "transfer","payTv"];
        if (services.includes(params.code) == false) {
            redirect('/dashboard');
        }
    ...
    methods: {
        ...
        getransactions() {
            ...
            this.$axios.post(`${process.env.baseUrl}transactions/admin/payment`,
                {
