                        ...
                        <Table>
                            ...
                            <tbody v-if="transactions.length != 0">
                                <tr v-for="(transaction, index) in transactions" :key="index">
                                    ...
                                    <td>
                                        <b-button  size="sm" :to="`/dashboard/transfers/${transaction.id}`" variant="primary">More</b-button>
                                    </td>
                                </tr>
                            </tbody>
                            <tbody v-else>
                                <tr>
                                    <td colspan="11" class="text-center"> <h3> No record... </h3> </td>
                                </tr>
                            </tbody>
                        </Table>
                        <div class=" col-md-12">
...
export default {
    ...
    methods: {
        ...
        getransactions() {
            ...
            this.$axios.post(`${process.env.baseUrl}transfer/admin/list`,
                {
